...
const Header = () => {
  ...
  return (
    <>
      ...
      <a 
        href="#main-content" 
        className="sr-only focus:not-sr-only focus:absolute focus:top-4 focus:left-4 focus:z-[2000] focus:bg-saffron focus:text-blue-main focus:p-4 focus:rounded-md focus:font-bold focus:shadow-xl"
      >
        Skip to main content
      </a>

      <header className="fixed top-0 left-0 right-0 h-16 bg-white z-[1000] flex items-center justify-between px-4 md:px-8 shadow-sm border-b border-border-gray" role="banner">
        <Link 
          to="/"
        ...
        >
          <span className="material-icons" aria-hidden="true">how_to_vote</span>
        ...
        <nav className="hidden md:flex gap-6 items-center" aria-label="Main Navigation">
          ...
          >
            <span className="material-icons text-base" aria-hidden="true">emergency</span>
            {t('nav.emergency')}
          </a>
        </nav>
